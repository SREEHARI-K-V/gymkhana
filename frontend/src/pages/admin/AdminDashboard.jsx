      ...
      <div className="row g-4">
        ...
        <div className="col-12 col-lg-8">
          <div className="glass-card-static p-4 h-100">
            ...
            <div style={{ height: '240px' }} className="d-flex align-items-end justify-content-between gap-3 pt-4 px-3">
              {(stats.revenue_trend?.months || []).map((m, idx) => {
                ...
                return (
                  <div key={m} className="d-flex flex-column align-items-center flex-grow-1 h-100 justify-content-end">
                    <small className="text-cyan fw-bold mb-2">${rev >= 1000 ? `${(rev/1000).toFixed(1)}k` : rev}</small>
                    <div
                    ...
                    />
                    <span className="text-muted mt-2 small fw-semibold">{m}</span>
                  </div>
                );
              })}
            </div>
      ...
      <div className="glass-card-static p-4">
        ...
        <div className="row g-3">
          {(stats.trainer_load || []).map((t) => (
            <div key={t.trainer_id} className="col-12 col-md-4">
              <div className="p-3 glass-card rounded-3 d-flex align-items-center justify-content-between">
                ...
                <div className="text-end">
                  <span className="badge badge-role fs-6">{t.assigned_members_count} Clients</span>
                </div>
              </div>
            </div>
          ))}
